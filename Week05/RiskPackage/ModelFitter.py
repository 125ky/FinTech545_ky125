...
''' 
        ...
        Te data should be np.array format.
        ...
        Then I have a chain of same distributions but each distribution may have different 
        parameters and I could use them to do the copula simulation.
'''
